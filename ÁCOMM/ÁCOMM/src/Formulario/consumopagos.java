...
public class consumopagos extends JFrame  implements ActionListener, MouseListener, KeyListener, MouseMotionListener{
	...
	public consumopagos() {
		...
		btnFiltrarConsumos.setForeground(Color.DARK_GRAY);
		btnFiltrarConsumos.setCursor(Cursor.getPredefinedCursor(Cursor.HAND_CURSOR));
		btnFiltrarConsumos.addActionListener(this);
		btnFiltrarConsumos.setFont(new Font("Times New Roman", Font.BOLD, 12));
		...
		label_18 = new JLabel("");
		label_18.setIcon(new ImageIcon(consumopagos.class.getResource("/img/anaran.png")));
		label_18.setBounds(0, 0, 666, 39);
		...
		scrollPane_3.setBounds(0, 40, 666, 552);
